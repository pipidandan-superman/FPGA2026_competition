...
来源：[PYNQ报告](E:/competition/4_metrics/logs/2026-09-11_pynq_camera_run01/REPORT.md)、[PC原始统计](E:/competition/4_metrics/logs/2026-09-11_pynq_camera_run01/pc_final_status.json)、[模型说明](E:/competition/3_host/model/MODEL.md)、[最新环境报告](E:/competition/4_metrics/logs/2026-09-12_model_env_run01/REPORT.md)。本轮读取既有证据，没有重新上板。
...
![系统架构](E:/competition/4_metrics/logs/2026-09-12_amd_arm_only_design_run01/architecture.png)
...
![固定相机几何和分段动作](E:/competition/4_metrics/logs/2026-09-12_amd_arm_only_design_run01/geometry_and_states.png)
...
复用入口：[板端摄像头程序](E:/competition/2_fpga/0_diaplay_test/pynq/camera.py)、[UDP接收器](E:/competition/3_host/udp_video/udp_video_rx.py)、[稳定模型环境](E:/competition/3_host/model_env/README.md)。源码/模型/bit/xsa/hwh/标定文件均绑定版本与哈希。
...
赛题源：[AMD赛题PDF](E:/competition/1_docs/pdf/AMD赛题.pdf) 3.2节；MinerU pipeline结果MINERU_PARSE_PASS，输入SHA-256匹配、中文质量pass、无解析回退。完整SHA、Markdown和content JSON路径见[本次来源核验](E:/competition/4_metrics/logs/2026-09-12_amd_arm_only_design_run01/source_verification.json)。[研究与交付记录](E:/competition/4_metrics/logs/2026-09-12_amd_arm_only_design_run01/report.md)区分已验证事实、设计计算和未完成实验。
