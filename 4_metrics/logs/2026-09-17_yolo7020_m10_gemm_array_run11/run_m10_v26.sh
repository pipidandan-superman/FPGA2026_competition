#!/bin/bash
# M10 v26 gate: iteration-11 (requant V1.2f PIPE 5->6 + addrgen V1.3 decode split)
cd /e/competition/2_fpga/3_yolo_zynq/sim/xsim
XV=/f/vivado2025/2025.2/Vivado/bin
$XV/xvlog.bat -work work_m10v26 \
  ...
  -log m10_v26_xvlog.log || exit 1
$XV/xelab.bat work_m10v26.tb_yolo_gemm_array work_m10v26.glbl \
  -s snap_m10v26 -L unisim -L unisims_ver -timescale 1ns/1ps \
  -log m10_v26_xelab.log || exit 1
$XV/xsim.bat snap_m10v26 -R -log m10_v26_xsim.log
