...
# gate  : GEMM16_OOC_TIMING_60M_PASS  (WNS >= 0 @ create_clock 16.667ns)
# ============================================================
...
create_clock -period 16.667 -name clk_i [get_ports clk_i]
...
report_utilization    -file $OUT/ooc_v28b60_utilization.rpt
report_timing_summary -file $OUT/ooc_v28b60_timing.rpt
report_drc            -file $OUT/ooc_v28b60_drc.rpt
report_route_status   -file $OUT/ooc_v28b60_route_status.rpt
write_checkpoint      -force $OUT/ooc_v28b60_routed.dcp
...
puts "OOC_V28B60_RES dsp48e1=$ndsp ramb36=$nbram36 ramb18=$nbram18"

# ---- worst-N owners ----
report_timing -max_paths 10 -path_type summary \
    -file $OUT/ooc_v28b60_top10.rpt
...
if {$wns >= 0} {
    puts "GEMM16_OOC_TIMING_60M_PASS wns_ns=$wns whs_ns=$whs fmax_mhz=$fmax target_mhz=60.0"
} else {
    puts "GEMM16_OOC_TIMING_60M_FAIL wns_ns=$wns whs_ns=$whs fmax_mhz=$fmax target_mhz=60.0"
}
