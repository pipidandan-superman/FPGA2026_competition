#!/bin/bash
# M0 批量仿真：yolo_conv_core.v 通用核 TB_CONVGEN 全用例
# 每用例独立 transcript 落本 run 目录（sim_<case>.log，原始不改名）
...
LOGROOT=E:/competition/4_metrics/logs/2026-09-15_yolo7020_m0_conv_core_run01
