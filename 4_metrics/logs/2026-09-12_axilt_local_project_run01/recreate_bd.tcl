...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD\
0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#ENET Reset#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
    CONFIG.PCW_MIO_TREE_SIGNALS {cd#gpio[1]#gpio[2]#gpio[3]#gpio[4]#gpio[5]#gpio[6]#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#reset#tx#rx#gpio[50]#gpio[51]#mdc#mdio}\
\
  ...
  # Create instance: axi_lite_test_0, and set properties
  set block_name axi_lite_test_top
  set block_cell_name axi_lite_test_0
  if { [catch {set axi_lite_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_lite_test_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: control_reset, and set properties
  set control_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 control_reset ]
  ...
  connect_bd_intf_net -intf_net control_interconnect_M00_AXI [get_bd_intf_pins control_interconnect/M00_AXI] [get_bd_intf_pins axi_lite_test_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_M_AXI_GP0 [get_bd_intf_pins ps7/M_AXI_GP0] [get_bd_intf_pins control_interconnect/S00_AXI]

  # Create port connections
  connect_bd_net -net const_one_dout  [get_bd_pins const_one/dout] \
  [get_bd_pins control_reset/dcm_locked]
  connect_bd_net -net const_zero_dout  [get_bd_pins const_zero/dout] \
  [get_bd_pins control_reset/aux_reset_in] \
  [get_bd_pins control_reset/mb_debug_sys_rst]
  connect_bd_net -net control_reset_peripheral_aresetn  [get_bd_pins control_reset/peripheral_aresetn] \
  ...
  [get_bd_pins control_reset/slowest_sync_clk] \
  [get_bd_pins axi_lite_test_0/clk]
  connect_bd_net -net ps7_FCLK_RESET0_N  [get_bd_pins ps7/FCLK_RESET0_N] \
  [get_bd_pins control_reset/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_lite_test_0/S_AXI/reg0] -force
