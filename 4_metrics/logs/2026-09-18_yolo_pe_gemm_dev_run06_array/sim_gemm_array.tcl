# =====================================================================
# sim_gemm_array.tcl - manual step 3b/4 array gate sim, three tiers
# (4x4 unit-debug / 8x16 baseline / 16x16 parameterized) from ONE TB.
# MAC grid carries real DSP48E1 PEs -> unisim libs + glbl required.
# Run by: cmd //c vivado.bat -mode batch -source sim_gemm_array.tcl
# =====================================================================
