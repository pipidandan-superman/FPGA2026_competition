# =====================================================================
# sim_gemm_array_bmg.tcl - run14: array gate, BMG IP redo (user order
# sequence 4). DUT = yolo_gemm_array V2.1 (coordinate mirror deepened
# 3->4 to match the tail V2.0 BMG LUT, D+4) + yolo_gemm_tail V2.0 with
# the REAL gemm_bm_lut IP inside. Three elaboration tiers 4x4/8x16/16x16
# from ONE TB, identical stimulus/golden to run06/run08 -> per-number
# realignment expected (846/4250/6881). MAC grid carries real DSP48E1
# PEs and the tail carries a real BMG -> unisim libs + blk_mem_gen
# precompiled lib + glbl required.
# Run by: cmd //c vivado.bat -mode batch -source sim_gemm_array_bmg.tcl
# =====================================================================
