# EES-331 PS7 board config (extracted from display_test.bd)
# + A2 overrides: FCLK0=60MHz (board first-light), HP0/HP1 + GP0 on
# 值形态：str -> {v}；list -> {{e0} {e1}}（首版把 list 写成
# Python repr ['..','..']，方括号被 IP update_all 二次求值炸掉）
set ps7_cfg {
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {{SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet} {0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#ENET Reset#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}}
