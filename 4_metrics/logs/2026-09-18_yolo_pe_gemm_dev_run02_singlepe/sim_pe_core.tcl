# =====================================================================
# sim_pe_core.tcl - single-PE gate sim (xsim + unisim DSP48E1)
# Gate mode: directed golden + corners + mask sweep + 200k random +
#            reset gates + latency scoreboard.
# Run by: cmd //c vivado.bat -mode batch -source sim_pe_core.tcl
...
run_tool [file join $xsimbin xelab.exe] -debug off -timescale {1ns/1ps} \
    -L unisims_ver -L unisim -s tb_pe_gate tb_yolo_pe_core glbl

puts "EES_VIVADO_STAGE SIMULATE"
run_tool [file join $xsimbin xsim.exe] tb_pe_gate -runall \
