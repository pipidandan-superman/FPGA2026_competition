#!/bin/bash
# M10 v24 gate: iteration-10 (requant V1.2e windowed decode)
cd /e/competition/2_fpga/3_yolo_zynq/sim/xsim
XV=/f/vivado2025/2025.2/Vivado/bin
$XV/xvlog.bat -work work_m10v24 \
  ...
  -log m10_v24_xvlog.log || exit 1
$XV/xelab.bat work_m10v24.tb_yolo_gemm_array work_m10v24.glbl \
  -s snap_m10v24 -L unisim -L unisims_ver -timescale 1ns/1ps \
  -log m10_v24_xelab.log || exit 1
$XV/xsim.bat snap_m10v24 -R -log m10_v24_xsim.log
