#!/bin/bash
# M12 csr engine gate v26 (engine_top level, iteration-11 RTL):
...
$XV/xvlog.bat -work work \
  ...
  -log eng_v26_xvlog.log || exit 1
$XV/xelab.bat work.tb_yolo_engine_top work.glbl \
  -s snap_eng_v26 -L blk_mem_gen_v8_4_12 -L unisim -L unisims_ver \
  -timescale 1ns/1ps -log eng_v26_xelab.log || exit 1
$XV/xsim.bat snap_eng_v26 -R -log eng_v26_xsim.log
