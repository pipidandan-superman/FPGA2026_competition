#!/bin/bash
# M5 v25 gate: requant V1.2f (prod2_r fabric re-register, PIPE 5->6,
...
$XV/xvlog.bat -work work_m5v25 \
  ...
  -log m5_v25_xvlog.log || exit 1
$XV/xelab.bat work_m5v25.tb_yolo_requant work_m5v25.glbl \
  -s snap_m5_v25 -L unisim -L unisims_ver -timescale 1ns/1ps \
  -log m5_v25_xelab.log || exit 1
$XV/xsim.bat snap_m5_v25 -R -log m5_v25_xsim.log
