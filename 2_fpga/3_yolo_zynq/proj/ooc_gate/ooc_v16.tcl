...
#   计数不增.
# batch : vivado -mode batch -source ooc_v16.tcl -nojournal
...
report_utilization    -file $OUT/ooc_v16_utilization.rpt
report_timing_summary -file $OUT/ooc_v16_timing.rpt
report_drc            -file $OUT/ooc_v16_drc.rpt
report_route_status   -file $OUT/ooc_v16_route_status.rpt
write_checkpoint      -force $OUT/ooc_v16_routed.dcp
