...
# batch : vivado -mode batch -source ooc_v24.tcl -nojournal
...
report_utilization    -file $OUT/ooc_v24_utilization.rpt
report_timing_summary -file $OUT/ooc_v24_timing.rpt
report_drc            -file $OUT/ooc_v24_drc.rpt
report_route_status   -file $OUT/ooc_v24_route_status.rpt
write_checkpoint      -force $OUT/ooc_v24_routed.dcp
