/************************************************************************
 * File Name     : tb_yolo_gemm_tail_bmg.sv
 * Developer     : LSL
 * Date          : 2026-09-19
 ...
 *   X 绊线、K=1 式记账守恒、延迟硬查（cyc−tag==4）、rst 在飞击杀。
 * Revision History:
 *   - V1.0 (2026-09-18) by LSL : run05 TB（D+3，寄存阵列 LUT）。
 *   - V2.0 (2026-09-19) by LSL : run13 适配——延迟 4、BMG IP LUT。
 ************************************************************************/

`timescale 1ns/1ps

module tb_yolo_gemm_tail_bmg;
