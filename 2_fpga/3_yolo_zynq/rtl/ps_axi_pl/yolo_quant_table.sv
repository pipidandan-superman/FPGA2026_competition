/************************************************************************
 * File Name       : yolo_quant_table.sv
 * Developer       : LSL
 * Date            : 2026-09-18
 * Project Name    : AMD embodied sorting / EES-331 XC7Z020
 * Module Name     : yolo_quant_table
 * Description     : Quantization parameter table: 256 profiles x 4
 *                   words = 1024 x 32 BRAM, implemented with a Block
 *                   Memory Generator IP (yolo_quant_bram, true dual
 *                   port, byte write enable, output registers DISABLED
 *                   -> read latency 1 cycle).
 *                   Port A = AXI aperture, port B unused.
 * Dependencies    : ip/yolo_quant_bram (BMG v8.4 XCI)
 * Revision History:
