...
本目录集中存放已下载并完成结构校验的训练数据集。数据本体（ZIP/图片/标签）仅本地保留，不上传 Git。

## Hand Gesture v6（YOLOv8 格式）｜2026-09-14

- 原始 ZIP：`Hand_Gesture_v6_yolov8.zip`，29,538,322 字节，SHA-256 `89b828c8bfad60243f790d58d896b5189a7ac6f3c498629fdd931b8179e378b5`
- 解压目录：`dataset/`（data.yaml + train/valid/test，各含 images/ 与 labels/）
