...
> 2026-09-19 更新：上行为 2026-09-14 时点快照。此后已落地——整数参考与 RNE 量化（intref_yolov8.py，run04 位级对拍）、GEMM 数据通路 RTL 板级闭环（run23 BOARD_B1_PASS，288/288 零错）；分类/DFL/NMS 的 PS 侧与 B4 全联仍在途，见 `1_docs/` 各执行计划与 `4_metrics/logs/`。
